class Solution:
    """
    Unlike Approach 1, which processes the string from left to right,
    this approach enumerates the boundary position i from right to left.
    This allows us to avoid constructing and comparing strings during each iteration
    and only requires checking an O(∣Σ∣) count array.
    """

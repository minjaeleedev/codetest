...
class Solution:
    """
    Approach 2: Stack
    If we regard the union operation (represented by commas) in the expression as addition and concatenation as multiplication,
    the process of evaluating the entire expression becomes analogous to evaluating an arithmetic infix expression.
    For example, {a,b}{c,{d,e}} can be viewed as {a,b}×{c+{d+e}}.
    """
